...
<head>
    ...
    /* Global Error Message Styles - Outside Login Box */
    .global-error,
    .global-success {
        position: absolute;
        top: 20px;
    ...
    .global-error {
        animation: 
            ...
            shakeError 0.5s ease-in-out 0.5s;
    }
    ...
    /* Adjust login container for error messages */
    .login-container {
        display: flex;
        ...
        position: relative;
        background: 
            linear-gradient(135deg, rgba(0, 0, 0, 0.7) 0%, rgba(33, 37, 41, 0.8) 100%),
            url('https://images.unsplash.com/photo-1558981806-ec527fa84c39?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80') no-repeat center center/cover;
        background-attachment: fixed;
        min-height: 100vh;
    }

    /* Adjust login box position when error is present */
    .login-container:has(.global-error) .login-box,
    .login-container:has(.global-success) .login-box {
        margin-top: 40px;
    }

    /* Alternative method for browsers that don't support :has() */
    .login-container.with-error .login-box {
        margin-top: 40px;
    }
    ...
    body::before {
        ...
        width: 150%;
        height: 150%;
        background: radial-gradient(circle at 40% 60%, rgba(220, 53, 69, 0.06) 0%, transparent 50%);
        z-index: -1;
    ...
    body::after {
        ...
        width: 150%;
        height: 150%;
        background: radial-gradient(circle at 60% 40%, rgba(220, 53, 69, 0.04) 0%, transparent 50%);
        z-index: -1;
    ...
    .login-box::before {
        ...
        width: 80px;
        height: 4px;
        background: linear-gradient(90deg, #dc3545, #e63946, #dc3545);
    ...
    /* Error Message Styles inside form */
    .alert {
        padding: 12px 16px;
        border-radius: 8px;
        margin-bottom: 20px;
    ...
    /* Style input fields when there's an error */
